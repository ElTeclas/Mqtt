...
const brokerUrl = 'mqtt://201.188.251.191:1883'; // Dirección del broker MQTT

// Conectamos al broker MQTT
const client = mqtt.connect(brokerUrl);

// Conexión a MongoDB
mongoose.connect('mongodb://localhost:27017/mqttDB')
  .then(() => {
...
app.get('/api/trackHistory', (req, res) => {
  ...
  // Convertir los valores de fecha y hora a timestamps
